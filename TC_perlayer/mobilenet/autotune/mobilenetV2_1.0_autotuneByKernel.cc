...
DEFINE_string(
    options_cache,
    "autotune_msg_new_mobilenetV2_1.0",
...
TEST(mobilenet, 1_0)
{
    ...
    bestOptions = get_convolution_bestOption<tc::CudaBackend>(depthwise_S1_string, input, kernel);
    pExecutor = tc::aten::compile<tc::CudaBackend>(depthwise_S1_string, "convolution", {input, kernel}, bestOptions[0]);
    for (int i = 0; i < 15; i++) {
    ...
    bestOptions = get_convolution_bestOption<tc::CudaBackend>(depthwise_S2_string, input, kernel);
    pExecutor = tc::aten::compile<tc::CudaBackend>(depthwise_S2_string, "convolution", {input, kernel}, bestOptions[0]);
    for (int i = 0; i < 15; i++) {
