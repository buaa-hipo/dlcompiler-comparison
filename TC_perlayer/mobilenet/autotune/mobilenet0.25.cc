...
TEST(mobilenet, 0_25)
{
    ...
    /******************* conv_1x8x112x112_16x8x1x1_S1P0 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 8, 112, 112}); 
    kernel = makeATenTensor<tc::CudaBackend>({16, 8, 1, 1});
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x8x112x112_16x8x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x8x112x112_16x8x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x16x112x112_16x3x3_S2P1 ************************/
    time_use_sum = 0;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x16x112x112_16x3x3_S2P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x16x112x112_16x3x3_S2P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x16x56x56_32x16x1x1_S1P0 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 16, 56, 56}); 
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x16x56x56_32x16x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x16x56x56_32x16x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x32x56x56_32x3x3_S1P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 32, 58, 58}); 
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x32x56x56_32x3x3_S1P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x32x56x56_32x3x3_S1P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x32x56x56_32x32x1x1_S1P0 ************************/
    time_use_sum = 0;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x32x56x56_32x32x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x32x56x56_32x32x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x32x56x56_32x3x3_S2P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 32, 58, 58}); 
    kernel = makeATenTensor<tc::CudaBackend>({32, 3, 3});
    pExecutor = tc::aten::compile<tc::CudaBackend>(depthwise_S2_string, "convolution", {input, kernel}, bestOptions_depthwise_S2[0]);
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x32x56x56_32x3x3_S2P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x32x56x56_32x3x3_S2P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x32x28x28_64x32x1x1_S1P0 ************************/
    time_use_sum = 0;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x32x28x28_64x32x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x32x28x28_64x32x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x64x28x28_64x3x3_S1P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 64, 30, 30}); 
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x64x28x28_64x3x3_S1P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x64x28x28_64x3x3_S1P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x64x28x28_64x64x1x1_S1P0 ************************/
    time_use_sum = 0;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x64x28x28_64x64x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x64x28x28_64x64x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x64x28x28_64x3x3_S2P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 64, 30, 30}); 
    kernel = makeATenTensor<tc::CudaBackend>({64, 3, 3});
    pExecutor = tc::aten::compile<tc::CudaBackend>(depthwise_S2_string, "convolution", {input, kernel}, bestOptions_depthwise_S2[0]);
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x64x28x28_64x3x3_S2P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x64x28x28_64x3x3_S2P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x64x14x14_128x64x1x1_S1P0 ************************/
    time_use_sum = 0;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x64x14x14_128x64x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x64x14x14_128x64x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x128x14x14_128x3x3_S1P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 128, 16, 16}); 
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x128x14x14_128x3x3_S1P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x128x14x14_128x3x3_S1P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x128x14x14_128x128x1x1_S1P0 ************************/
    time_use_sum = 0;
    ...
    /******************* depthwise_1x128x14x14_128x3x3_S2P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 128, 16, 16}); 
    kernel = makeATenTensor<tc::CudaBackend>({128, 3, 3});
    pExecutor = tc::aten::compile<tc::CudaBackend>(depthwise_S2_string, "convolution", {input, kernel}, bestOptions_depthwise_S2[0]);
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x128x14x14_128x3x3_S2P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x128x14x14_128x3x3_S2P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x128x7x7_256x128x1x1_S1P0 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 128, 7, 7}); 
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x128x7x7_256x128x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x128x7x7_256x128x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;

    /******************* depthwise_1x256x7x7_256x3x3_S1P1 ************************/
    time_use_sum = 0;
    input = makeATenTensor<tc::CudaBackend>({1, 256, 9, 9}); 
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/depthwise_1x256x7x7_256x3x3_S1P1[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/depthwise_1x256x7x7_256x3x3_S1P1[Time]: " << time_use_sum << " us" << std::endl;

    /******************* conv_1x256x7x7_256x256x1x1_S1P0 ************************/
    time_use_sum = 0;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        if (i >= 5) time_use_sum += time_use;
        std::cout << "mobilenet/conv_1x256x7x7_256x256x1x1_S1P0[Round" << i <<"]: " << time_use << " us" << std::endl;
    }
	time_use_sum /= 10;
	std::cout << "mobilenet/conv_1x256x7x7_256x256x1x1_S1P0[Time]: " << time_use_sum << " us" << std::endl;
